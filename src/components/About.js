      ...
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-20">
          ...
          <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
            ...
            facilitating individuals to reduce and control their carbon
            footprint. Focused towards solving United nations SDGs
          </p>
        </div>
        <div class="flex flex-wrap">
          ...
          <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
            ...
            <Link to="/tracks" class="text-green-500 inline-flex items-center">
              Learn More
              <svg
                fill="none"
                stroke="currentColor"
          ...
          <div class="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
            ...
            <p class="leading-relaxed text-base mb-4">
              Find your friends and learn how they contribute towards making
              this world a better place to live.
            </p>
            <a href="#" class="text-green-500 inline-flex items-center">
              Learn More
              <svg
                fill="none"
                stroke="currentColor"
