    ...
    <section class="text-gray-600 bg-gray-900 body-font px-10">
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-20">
          <h1 class="text-2xl font-medium title-font mb-4 text-gray-400 tracking-widest">
            OUR TEAM
          </h1>
          ...
          <div class="p-4 lg:w-1/2">
            <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
              ...
              <div class="flex-grow sm:pl-8">
                <h2 class="title-font font-medium text-lg text-gray-200">
                  Khushboo Agnihotri
                </h2>
                <h3 class="text-gray-300 mb-3">UI & Web Developer</h3>
                <p class="mb-4 text-gray-400">
                  Ut proident irure ipsum occaecat labore est incididunt
          ...
          <div class="p-4 lg:w-1/2">
            <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
              ...
              <div class="flex-grow sm:pl-8">
                ...
                <h3 class="text-gray-300 mb-3">Ml & Web Developer</h3>
                <p class="mb-4 text-gray-400">
                  Incididunt excepteur est nulla commodo commodo dolor laboris.
                </p>
                <span class="inline-flex">
                  <a
          ...
          <div class="p-4 lg:w-1/2">
            <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
              ...
              <div class="flex-grow sm:pl-8">
                ...
                <h3 class="text-gray-300 mb-3">Flutter Developer</h3>
                <p class="mb-4 text-gray-400">
                  Ipsum aute voluptate enim commodo dolor do nisi exercitation.
                </p>
                <span class="inline-flex">
                  <a
            ...
            <div class="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
              ...
              <div class="flex-grow sm:pl-8">
                ...
                <p class="mb-4 text-gray-300">
                  Deserunt nostrud aliquip occaecat amet.
                </p>
                <span class="inline-flex">
                  <a
